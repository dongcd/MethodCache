namespace MethodCache.Fody
{
    ...
    public class ModuleWeaver
    {
        ...
        public const string CacheAttributeSpecialKeyPrefixName = "CacheKeyPrefix";
        ...
        private static string CreateCacheKeyString(MethodDefinition methodDefinition, string CacheKeyPrefix = null)
        {
        ...
        private void WeaveMethod(MethodDefinition methodDefinition, CustomAttribute attribute, MethodReference propertyGet)
        {
            ...
            CustomAttributeNamedArgument cusAttrArg = attribute.Properties.FirstOrDefault(findKey => findKey.Name.ToLower() == CacheAttributeSpecialKeyPrefixName.ToLower());
            ...
            string cacheKeyPrefix = !string.IsNullOrEmpty(cusAttrArg.Name) ? (string.IsNullOrEmpty(cusAttrArg.Argument.Value.ToString()) ? string.Empty : cusAttrArg.Argument.Value.ToString()) : string.Empty;
            string cacheKey = CreateCacheKeyString(methodDefinition, cacheKeyPrefix);
